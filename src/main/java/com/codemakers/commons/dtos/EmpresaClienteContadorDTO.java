 ...
 * @version 1.0
 * 
 * Clase DTO que permite encapsular los datos de un objeto de tipo (EmpresaClienteContadorEntity).
...
@NoArgsConstructor
@Builder
public class EmpresaClienteContadorDTO implements Serializable{

 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (TipoCuentaContable) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "tipo_cuenta_contable", schema = "configuracion")
@EntityListeners(AuditingEntityListener.class)
public class TipoCuentaContableEntity implements Serializable {

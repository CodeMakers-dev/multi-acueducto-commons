 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (TipoNovedad) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "tipo_novedad", schema = "configuracion")
@EntityListeners(AuditingEntityListener.class)
public class TipoNovedadEntity implements Serializable {

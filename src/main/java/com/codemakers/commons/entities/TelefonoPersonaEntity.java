 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (TelefonoPersona) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "telefono_persona", schema = "public")
@EntityListeners(AuditingEntityListener.class)
public class TelefonoPersonaEntity implements Serializable {

 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (ParametrosGenerales) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "parametros_generales", schema = "configuracion")
@EntityListeners(AuditingEntityListener.class)
public class ParametrosGeneralesEntity implements Serializable {

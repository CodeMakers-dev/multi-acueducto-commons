 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (EmpresaClienteContador) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "empresa_cliente_contador", schema = "public")
@EntityListeners(AuditingEntityListener.class)
public class EmpresaClienteContadorEntity implements Serializable{

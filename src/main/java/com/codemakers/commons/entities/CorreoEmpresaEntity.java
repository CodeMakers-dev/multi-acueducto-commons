 ...
 * @version 1.0
 * 
 *          Clase Entity de tipo (CorreoEmpresa) que representa un registro de
...
@Entity
@NoArgsConstructor
@Table(name = "correo_empresa", schema = "public")
@EntityListeners(AuditingEntityListener.class)
public class CorreoEmpresaEntity implements Serializable {
